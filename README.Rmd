...
The **asa.rosie** package provides a simple implementation of **Kernel Ridge Regression (KRR)**  
using a Gaussian kernel. It allows users to easily fit nonlinear regression models  
...
You can install the development version of asa.rosie from [GitHub](https://github.com/) with:
